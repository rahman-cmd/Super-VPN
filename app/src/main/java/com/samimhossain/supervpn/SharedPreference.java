package com.samimhossain.supervpn;
...
import static com.samimhossain.supervpn.Utils.getImgURL;

public class SharedPreference {

    private static final String APP_PREFS_NAME = "OKVPNPreference";
    ...
    public Server getServer() {
        ...
        Server server = new Server(
                ...
                mPreference.getString(SERVER_FLAG,getImgURL(R.drawable.jp)),
