...
import com.samimhossain.supervpn.CheckInternetConnection;
import com.samimhossain.supervpn.R;
import com.samimhossain.supervpn.SharedPreference;
import com.samimhossain.supervpn.databinding.FragmentMainBinding;
...
public class MainFragment extends Fragment implements View.OnClickListener, ChangeServer {
        ...
        if (connectionState != null)
            switch (connectionState) {
                ...
                case "RECONNECTING":
                    ...
                    break;
                case "NONETWORK":
                    binding.logTv.setText("  No Internet  ");
                    break;
            }
    ...
    public void status(String status) {
        ...
        if (status.equals("connect")) {
            binding.vpnBtn.setBackgroundResource(R.drawable.on_btn);
        } else if (status.equals("connecting")) {
            binding.vpnBtn.setBackgroundResource(R.drawable.wait_btn);
        } else if (status.equals("connected")) {
            binding.vpnBtn.setBackgroundResource(R.drawable.off_btn);
